...
:py:mod:`kinisi` has the following functionality:
...
- the :py:class:`uravu.relationship.Relationship` class is leveraged to propagate these uncertainties using Bayesian inference and enable the determination of the uncertainty in the diffusion coefficient and activation energy,
