...
class TestFunctions(unittest.TestCase):
    ...
    def test_find_non_psd_matrix(self):
        start_matrix = np.array([[0.99, 0.78, 0.59, 0.44], [0.78, 0.92, 0.28, 0.81], [0.59, 0.28, 1.12, 0.23],
                                 [0.44, 0.81, 0.23, 0.99]])
    ...
    def test_check_psd_matrix(self):
        start_matrix = np.eye(20)
        assert check_positive_definite(start_matrix) is True

    def test_check_non_psd_matrix(self):
        start_matrix = np.array([[0.99, 0.78, 0.59, 0.44], [0.78, 0.92, 0.28, 0.81], [0.59, 0.28, 1.12, 0.23],
                                 [0.44, 0.81, 0.23, 0.99]])
        assert check_positive_definite(start_matrix) is False
