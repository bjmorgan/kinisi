...
class Parser:
    ...
    Attributes:
        time_step (:py:attr:`float`): Time step, in picoseconds, between steps in trajectory.
    ...
    """
    def __init__(self, disp, indices, framework_indices, time_step, step_skip, min_obs=30, min_dt=1, ndelta_t=75, progress=True):
